...
// Drží API klíč v tajnosti na serveru a přeposílá požadavek na Anthropic API.
...
export default async function handler(req, res) {
  ...
  if (!apiKey) {
    return res.status(500).json({ error: 'Server není nakonfigurován (chybí ANTHROPIC_API_KEY).' });
  }
